...
clang -Os -ffreestanding -nostdlib -fno-stack-protector -fno-pie -fno-pic -mno-sse -target x86_64-unknown-gnu-linux -c kmain.c libvga/vga_driver.c string/string.c
